...
R.: Foi entender a função de cada função e como elas se relacionam, principalmente os parâmetros base, desc e fin. Foi necessário acompanhar o código desde a entrada dos dados até o cálculo do desconto e a exibição do resultado.
...
R.: Porque perguntas e sugestões nos permitem entender o problema e pensar em uma solução, evitando conflitos. Além disso, facilita a troca de ideias e pode ajudar a equipe a encontrar formas melhores de organizar e melhorar o código.
